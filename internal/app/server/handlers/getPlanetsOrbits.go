...
func NewPlanetsOrbitsHandler(store sqlstore.StoreInterface, log *logrus.Logger) func(w http.ResponseWriter, r *http.Request) {
	return func(w http.ResponseWriter, r *http.Request) {
		const path = "handlers.getNatal.NewPlanetsOrbitsHandler"
		...
		w.Write([]byte(pageAssembler.GetPlanetOrbit(chart)))
		return
	}
}
