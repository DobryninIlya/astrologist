...
func NewPlanetAspectsHandler(store sqlstore.StoreInterface, log *logrus.Logger) func(w http.ResponseWriter, r *http.Request) {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		w.Write([]byte(pageAssembler.GetNatalPlanetsAspectsResult(chart)))
		return
	}
}
